...
#define JUDGE_TANK		1
#define JUDGE_AUXILIARY 2
#define JUDGE_INFANTRY1 3
#define JUDGE_INFANTRY2 4
#define JUDGE_INFANTRY3 5
#define JUDGE_UAV		6
#define JUDGE_SENTRY	7
...
typedef struct{
	...
	ext_rfid_status_t						extRfidStatus;
	ext_dart_client_cmd_t					extDartClientCmd;
