...
void sensorProcessUpdate(imusensorStruct_t *imuSensor,coordinateFloat_t *accdata,coordinateFloat_t *gyodata,coordinateFloat_t *magdata,int16_t tempreature){
...
float meanRecursiveFilter(int16_t newVuale,uint8_t axis){
