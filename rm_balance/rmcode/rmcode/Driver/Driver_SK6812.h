...
#define SK6812_LED_STRIP_LENGTH    7			//LED数量
...
//Timer setting
#define SK6812_TIMER			   TIM3
#define SK682_DMA_TIMCH			   TIM_DMA_CC3
#define SK6812_BSP_DMA_TIM_GR      BSP_DMA_TIM3_CH3
#define SK6812_GPIO				   BSP_GPIOB0
#define SK6812_TIMER_MHZ           84
#define SK6812_CARRIER_HZ          800000   //数据发送速率800Kbps
