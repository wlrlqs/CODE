...
***************************************************
*/
void Driver_Multi_Master_Init(USART_TypeDef *USARTx,BSP_GPIOSource_TypeDef *USART_RX,BSP_GPIOSource_TypeDef *USART_TX,uint8_t PreemptionPriority,uint8_t SubPriority){
